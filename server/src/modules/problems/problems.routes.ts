...
router.get("/", auth(), validate(problemQuerySchema), ProblemController.list);

router.get("/search", auth(), validate(searchProblemSchema), ProblemController.search);

router.get("/:id", auth(), validate(problemIdParams), ProblemController.getById);
